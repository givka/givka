...
class MovieDataBase {
  ...
  static getGenreList() {
    ...
    return _getRequest(url, null);
  }

  static getArt() {
    const url = 'https://www.wikiart.org/en/App/Painting/MostViewedPaintings?offset=0&quantity=100&limit=100&randomSeed=123&json=2';
    return rp({
      method: 'GET',
      url,
      json: true,
  ...
  static getArtists() {
    const url = 'https://www.wikiart.org/en/app/api/popularartists?json=1';
    return rp({
      method: 'GET',
      url,
      json: true,
